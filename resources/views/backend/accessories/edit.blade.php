        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('accessories.update',$accessory->id) }}" method="POST" enctype="multipart/form-data">@method('PUT')
                            @csrf
                            <div class="form-group mb-3 lg-gutters-20 text-center">
                                <label for="name"><strong>{{trans('all.English Name')}}</strong></label>
                                <input type="text" value="{{$accessory->name}}" name="name" class="form-control" required>
                            </div>
                            <div class="form-group mb-3 lg-gutters-20 text-center">
                                <label for="name"><strong>{{trans('all.Arabic Name')}}</strong></label>
                                <input type="text" value="{{$accessory->name_ar}}" name="name_ar" class="form-control" required>
                            </div>

                            <div class="form-group mb-3 lg-gutters-20 text-center">
                                <label for="title"><strong>{{trans('all.English Title')}}</strong></label>
                                <input type="text" value="{{$accessory->title}}" name="title" class="form-control" required>
                            </div>
                            <div class="form-group mb-3 lg-gutters-20 text-center">
                                <label for="title"><strong>{{trans('all.Arabic Title')}}</strong></label>
                                <input type="text" value="{{$accessory->title_ar}}" name="title_ar" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group mb-3 lg-gutters-25 text-center">
                                ...
                                <input type="number" name="order" class="form-control" value="{{$accessory->order}}">
                            </div>
                            <div class="form-group mb-3 lg-gutters-25 text-center">
                                <label for="cover"><strong>{{trans('all.Cover')}}</strong></label>
                                <input type="file" class="form-control" name="cover" @if(!$accessory->cover) required @endif>
                            </div>
                            @if($accessory->cover)
                            <div class="row">
                                <div class="col-3">
                                    <div class="row" style="height: 100%">
                                        ...
                                        <img style="width:100%; height: 100%" src="{{asset($accessory->cover)}}" alt="{{$accessory->name}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3 lg-gutters-25 text-center">
                                ...
                                <input type="file" class="form-control" name="image" @if(!$accessory->image) required @endif>
                            </div>
                            @if($accessory->image)
                            <div class="row">
                                <div class="col-3">
                                    <div class="row" style="height: 100%">
                                        <div class="col-12" style="height: 100%">
                                        <img style="width:100%; height: 100%" src="{{asset($accessory->image)}}" alt="{{$accessory->name}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
