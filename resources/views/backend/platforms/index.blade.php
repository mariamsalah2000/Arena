                    ...
                    <tbody>
                        @foreach ($platforms as $key => $platform)
                            @if ($platform != null)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td style="width: 25%"><img style="width: 100%" src="{{ asset($platform->img) }}">
                                    </td>
                                    <td style="width: 25%">{{ $platform->title }}</td>
                                    <td style="width: 25%">{{ $platform->subtitle }}</td>
                                    <td style="width: 25%">{{ $platform->desc }}</td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="{{ route('platforms.destroy', $platform->id) }}"
                                            class="btn btn-soft-primary btn-icon btn-circle btn-sm"
