...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_front/css/careers.css') }}">
...
<body>
    ...
    <section class="jobs mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container text-center">
            ...
            <div class="row justify-content-between">
                <div class="col-xl-4 col-lg-4 col-md-4 my-auto mx-auto">
                    <h2>
                        our mission
                    </h2>
                    <p>
                    ...
                    <div class="row justify-content-center">
                        <a class="btn button- w-50" href="#" role="button">view job</a>
                    </div>
                </div>
