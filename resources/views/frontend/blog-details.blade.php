...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_front/css/blog-details.css') }}">
...
<body>
    <header class="header-image">
        ...
        <div class="row header-img">
            <div class="col-xl-12">
                <img src="{{ asset('assets_front/images/bread-bg.png') }}" style="width: 100%; height: 550px;">
            </div>
        </div>
    </header>

    <section class="blog mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-8 col-md-8">
                    <img src="{{ asset('assets_front/images/blg-f5.png') }}" style="width: 100%;">
                </div>
                <div class="category col-xl-4 col-lg-4 col-md-4">
                    <h3>
                        related posts
                    </h3>
                    <div class="d-flex justify-content-center mb-4 ms-4">
                        <div>
                            <img src="{{ asset('assets_front/images/rec1.png') }}">
                        </div>
                        <div>
                            <h5>
                                july 25,2022
    ...
    <section class="blog-details mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
            <div class="row justify-content-start">
                <div class="col-xl-8 col-lg-8">
                    <h2>
                        How to Optimise and Webinar to Earn Leads
                    </h2>
                    <p>
                        Research by American Marketing Association states that 60% of marketers include webinars in
                        their marketing strategy. A survey by Curata also backs the importance of webinars where 79% of
                        buyers are ready to share their contact details in exchange for webinar access.
                        <br>
                        Marketing refers to any activities that a company uses to promote its products and services and
                        improve its market share. In order to be successful, marketing requires a combination of
                        advertising savvy, sales, and the ability to deliver goods to end-users.<br> This is normally
                        undertaken by specific professionals or marketers who can work internally (for companies) or
                        externally with other marketing firms.Email was a popular marketing tool in the early days of
                        digital marketing. That focus shifted to search engines like Netscape, which allowed businesses
                        to tag and keyword stuff to get themselves noticed. The development of sharing sites like
                        Facebook made it possible for companies to track data to cater to consumer trends.<br>

                        Research by American Marketing Association states that 60% of marketers include webinars in
                        their marketing strategy. A survey by Curata also backs the importance of webinars where 79% of
                        buyers are ready to share their contact details in exchange for webinar access.<br>
                    </p>
                </div>
                <div class="category col-xl-4 col-lg-4 col-md-4">
                    <h3>
                    ...
                    <ul>
                        <li>
                            <a>
                                design <span class="num">(2)</span>
                            </a>
                        </li>
                        <li>
                            <a>
                                development <span class="num">(6)</span>
                            </a>
                        </li>
                        <li>
                            <a>
                                seo <span class="num">(4)</span>
                            </a>
                        </li>
                        <li>
                            <a>
                                digital marketing <span class="num">(1)</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <section class="blogs mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
