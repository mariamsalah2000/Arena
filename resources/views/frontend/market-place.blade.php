...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_front/css/market-place.css') }}">
...
<body>
    ...
    <section class="market-place mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-6 col-lg-6 col-md-6 my-auto mx-auto">
                    ...
                    <p>
                        Marketing is always changing and evolving. Partner with a dedicated Marketing Success Manager
                        who works as hard as you do to help you stay ahead of the curve. They focus on creating and
                        executing modern digital marketing strategies to help you grow your business
                    </p>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 my-auto mx-auto">
    ...
    <section class="price mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4">
                    <div class="card-">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <a class="btn button" href="#" role="button">purchase now</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4">
