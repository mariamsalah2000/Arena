...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_front/css/creative-services.css') }}">
...
<body>
    ...
    <section class="creative-services mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
            <div class="row justify-content-center text-center">
                ...
                <p style="max-width: 60%;">
                    When we say “everything,” we mean just that. On top of great technology, you get access to US-based,
                    professional creative talent on-demand. Get a beautiful logo, matching swag, custom video,
