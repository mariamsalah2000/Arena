...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_front/css/services-details.css') }}">
...
<body>
            ...
            <div class="row justify-content-center">
                ...
                <div class="category col-xl-4 col-lg-4 col-md-4">
                    ...
                    <ul>
                        <li>
                            <a>
                                <span class="num">01</span> web development
                            </a>
                        </li>
                        <li>
                            <a>
                                <span class="num">02</span> web development
                            </a>
                        </li>
                        <li>
                            <a>
                                <span class="num">03</span> web development
                            </a>
                        </li>
                        <li>
                            <a>
                                <span class="num">04</span> web development
                            </a>
                        </li>
                        <li>
                            <a>
                                <span class="num">05</span> web development
                            </a>
                        </li>
                        <li>
                            <a>
                                <span class="num">06</span> web development
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <section class="services-details mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
            <div class="row justify-content-start">
                <div class="col-xl-8 col-lg-8">
                    ...
                    <p>
                        ...
                        In relation to websites and apps, UI design considers the look, feel, and interactivity of the
                        product. It’s all about making sure that the user interface of a product is as intuitive as
                        possible, and that means carefully considering each and every visual, interactive element the
                ...
                <div class="category col-xl-4 col-lg-4 col-md-4">
                    ...
                    <ul>
                        <li>
                            <a class="btn button" href="#" role="button">download pdf</a>
                        </li>
                        <li>
                            <a class="btn button" href="#" role="button">download word file</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="Service-Process mt-xl-5 mt-lg-5 mt-md-5">
        <div class="container">
            <h2>
                Service Process
            </h2>
    ...
    <section class="Service-outcome mt-xl-5 mt-lg-5 mt-md-10">
        <div class="container">
            <div class="row justify-content-start">
