...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_front/css/tour-by-industry.css') }}">
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">tour by industry</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="industry">
        <div class="container">
            <div class="row justify-content-center text-center">
                <h2>
                    See how Arena works for your industry.
                </h2>
            </div>
            <div class="row justify-content-center mb-3">
                @foreach ($industries as $key => $industry)
                    <div class="col-xl-2 col-lg-2 col-md-2 box">
                        <img src="{{ asset($indutry->img) }}" alt="">
